...
if (!trait_exists('SS_Conv_Tab')) :
    ...
    trait SS_Conv_Tab {
        ...
        public static function ss_conv_tab() {
            ...
            // enabled/disabled
            $enabled = get_post_meta($post->ID, 'ss_enabled', true);
                ...
                <div id="show_size_conv_tab_inner">
                    ...
                    <div class="options-group" style="border-bottom: 1px solid #e1e1e1;">
                        <p class="form-field shoe-size-conv-enable">
                            ...
                            <input type="checkbox" name="ss_enable_disable" id="ss_enable_disable" <?php echo $checked; ?>>
                        </p>
                    </div>
                    ...
                    <div class="options-group" style="border-bottom: 1px solid #e1e1e1;">
                        ...
                        <?php foreach ($sizes as $index => $size) : ?>
                            ...
                            <p>
                                ...
                                <input type="text" class="ss_matching_sizes_gb" value="<?php echo $uk_s[$index]; ?>" placeholder="<?php _e('UK size'); ?>" style="width:15%; margin-right:20px;">
